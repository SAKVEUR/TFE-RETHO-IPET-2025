...
porte1 = Porte(1, "%", 2, 3,1)

coffre = Coffre(1,"Bombe", "X", 3, 2,1)

# Placer les éléments autour du personnage
plateau.plateau[1][2] = "M"  # Mur en haut
plateau.plateau[2][3] = porte1  # Porte à droite
plateau.plateau[2][1] = monstre  # Monstre à gauche
plateau.plateau[3][2] = coffre  # Coffre en bas

# Placer le personnage au centre
plateau.plateau[2][2] = personnage
